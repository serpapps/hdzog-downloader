...
- Download supported HDZog videos directly from the page
...
- :bulb: Request features: [Feature Requests](https://github.com/serpapps/hdzog-downloader/issues)
...
- [Why HDZog Downloader](#why-hdzog-downloader)
- [Features](#features)
- [How It Works](#how-it-works)
- [Step-by-Step Tutorial: How to Download Videos from HDZog](#step-by-step-tutorial-how-to-download-videos-from-hdzog)
...
- [Notes](#notes)
- [License](#license)
- [About HDZog](#about-hdzog)

## Why HDZog Downloader

HDZog pages are built around streaming playback, not straightforward file saving. Generic downloaders often miss the actual media source or create a clumsy workflow for users who just want a usable MP4 copy.

HDZog Downloader is designed specifically for supported HDZog pages. It adds a direct browser-based workflow for detecting the media, selecting a quality, and exporting the final video as MP4 without extra tools.

## Features

- Video downloads from supported HDZog pages
...
- Automatic saving into a dedicated HDZOG folder
- Cross-browser support for Chrome, Edge, Brave, Opera, Firefox, Whale, and Yandex

## How It Works

1. Install the extension from the latest release.
2. Open HDZog and go to the video page you want to save.
...
## Step-by-Step Tutorial: How to Download Videos from HDZog

1. Install HDZog Downloader from the latest GitHub release.
2. Open HDZog and navigate to the video page you want.
...
- HDZog users who want offline copies of supported videos
...
- Save a supported HDZog video for offline viewing
...
1. Open the latest release page:
   [https://github.com/serpapps/hdzog-downloader/releases/latest](https://github.com/serpapps/hdzog-downloader/releases/latest)
2. Download the extension build for your browser.
3. Install the extension.
4. Open HDZog and navigate to a supported video page.
5. Use the extension controls to start downloading.

## FAQ

**Can I download HDZog videos directly from the page**  
...
They are saved to your default Downloads location, typically inside an HDZOG subfolder.
...
- Source quality depends on the media exposed by HDZog
...
HDZog is a streaming-focused video site where users often want a simple offline copy for later viewing, but the playback layer is not designed around direct file saving. HDZog Downloader simplifies that workflow with in-browser detection, quality selection, and MP4 export.
